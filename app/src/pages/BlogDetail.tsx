...
import { ArrowLeft, Clock, User, Calendar, Share2, Tag, CheckCircle, Linkedin, Quote, Info, AlertTriangle, Lightbulb, Sparkles, Twitter, ChevronDown, PlayCircle, ThumbsUp, ThumbsDown } from 'lucide-react';
